#!/bin/bash
# Modified from vagrant-ceph project
# https://github.com/openSUSE/vagrant-ceph/blob/master/openSUSE_vagrant_setup.sh
...
zypper_inst_cmd="/usr/bin/zypper -n in"
...
pretty_name="$(\
  ...
  | awk -F '"' '{ print $1 }'\
    ...
    /opt/vagrant/bin/vagrant plugin install vagrant-libvirt
